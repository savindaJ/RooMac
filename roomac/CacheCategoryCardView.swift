...
struct CacheCategoryCardView: View {
    ...
    init(category: StorageCategory, totalSize: Int64, onClear: @escaping () -> Void, onTap: @escaping () -> Void) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    HStack {
                        ...
                        // Warning badge
                        if category.size > 1_000_000_000 { // > 1GB
                            HStack(spacing: 4) {
                                Image(systemName: "exclamationmark.triangle.fill")
                                    .font(.system(size: 10))
                                Text("Cleanup Recommended")
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            RoundedRectangle(cornerRadius: 8)
                                ...
                                .shadow(color: Color.orange.opacity(0.6), radius: 5, x: 0, y: 2)
                        }
                    }
                    .frame(height: 8)
